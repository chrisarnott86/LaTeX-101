...
\title{\LaTeX{} 101 Sandbox}
\author{Created by A Student}
\date{2022}
...
\begin{abstract}
This document will introduce many of the features of \LaTeX. Edit the source on the left and see the output here.
\end{abstract}
...
This document is based on the \LaTeX.js example document: see on GitHub: \url{https://github.com/michael-brade/LaTeX.js}
